...
\begin{tabbing}
\hspace*{3cm}\= \hspace*{6cm} \= \hspace*{2cm} \= \hspace*{4cm} \= \kill
Ich möchte einen SSO-Account bekommen.
\\
(https://entropia.de/SSO): \Square ja \Square nein  \hspace*{4cm} \= \hspace*{4cm} \> Vorgeschlagen durch: \underline{\hspace{102pt}}
\end{tabbing}
\begin{itemize}
\item[] Ich habe die Satzung gelesen und m\"ochte Mitglied im Entropia e.V. werden.  \Square ja
\item[] Ich bin damit einverstanden, dass vor Aufnahme als Mitglied mein angegebener Nickname den Mitgliedern des Entropia e.V. mitgeteilt wird.  \Square ja
\end{itemize}
Meinen Beitrag in Höhe von \underline{\hspace{30pt}} €:\\
{\tiny Mindestens 5 €, empfohlener Beitrag siehe \url{https://entropia.de/Satzung_des_Vereins_Entropia_e.V.#Beitragsordnung}}
\begin{itemize}
